...
function App() {
  ...
  // WhatsApp helper
  const waNumber = '201026692536' // بدون + للـ wa.me
  const waText = encodeURIComponent('Hi Mohamed! I came from your portfolio.')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <motion.div className="flex-shrink-0" whileHover={{ scale: 1.05 }}>
              <h1 className="text-xl font-bold text-primary">Mohamed Ezzat</h1>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div className="space-y-8" initial="initial" animate="animate" variants={staggerContainer}>
            ...
            <motion.div className="flex justify-center space-x-6 pt-8" variants={fadeInUp}>
              <motion.a
                href="https://www.linkedin.com/in/mohamed-e-6a99a0224/"
                target="_blank"
              ...
              <motion.a
                href="mailto:mohammed.ezzatt00@gmail.com"
                className="text-muted-foreground hover:text-primary transition-colors"
                whileHover={{ scale: 1.2, rotate: -5 }}
                whileTap={{ scale: 0.9 }}
                aria-label="Email"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-8 pt-8 border-t border-border">
              <p className="text-sm text-muted-foreground">© 2025 Mohamed Ezzat Portfolio. All rights reserved.</p>
            </div>
          </div>
        </div>
      </motion.footer>
